...
x = 1:45;
figure
% plot(x, avg_miscls_rate_online_algo1(1:45), 'b', 'LineWidth', 2)
% hold on
plot(x, avg_miscls_rate_online_algo2(1:45), '-r', 'LineWidth', 2)
% hold off
